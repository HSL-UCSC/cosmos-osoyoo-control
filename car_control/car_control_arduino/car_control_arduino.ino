...
char ssid[] = "HSL_Router";  // your network SSID (name)
...
/***************** CAR DEFINES ***************/
// https://www.arduino.cc/reference/en/libraries/pwmservo/
#include <PWMServo.h>
// define Model X pins
#define IN1 7
#define IN2 8
...
#define FRONT 91    // adjust this value if your steer is not facing front at beginning
...
void loop()
{
  ...
  else if (velocity > 110 && velocity <= 200)
  {
