...
%             disp(gamma);
            ...
            gamma = gamma + 40;
            % send command to car, offset gamma by 40 to account for actual input range of car
            write(obj.udp, [gamma, v], 'uint8', '192.168.0.161', 8888);
%             write(obj.udp, [gamma, v], 'uint8', '169.233.152.23', 10002);
        end
        function obj = driveOn(obj, ~)
            obj = obj.drive(0, obj.gamma);
        end
