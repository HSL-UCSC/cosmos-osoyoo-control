...
%         max_gamma = deg2rad(40);
    ...
    methods
        function obj = PurePursuit_Control(waypoints, lookahead_dist)
            obj.waypoints = waypoints;
            obj.controller = controllerPurePursuit('DesiredLinearVelocity', 0.1, 'MaxAngularVelocity', 2*deg2rad(40), 'LookaheadDistance', lookahead_dist);
...
%                 obj.controller.Waypoints = obj.first_point;
%             elseif ~obj.reached_first_point && ~isequal(obj.first_point, [x_target y_target])
%                 disp("again")
%                 obj.reached_first_point = true;
